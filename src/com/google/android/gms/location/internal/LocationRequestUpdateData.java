  ...
  extends AbstractSafeParcelable
{
  ...
  public static LocationRequestUpdateData zza(LocationRequestInternal paramLocationRequestInternal, zzd paramzzd, @Nullable zzg paramzzg)
  {
    ...
    for (paramzzd = paramzzg.asBinder();; paramzzd = null) {
      return new LocationRequestUpdateData(1, 1, paramLocationRequestInternal, null, null, localIBinder, paramzzd);
    }
  }
  
  public static LocationRequestUpdateData zza(LocationRequestInternal paramLocationRequestInternal, zze paramzze, @Nullable zzg paramzzg)
  {
  ...
  public static LocationRequestUpdateData zza(zze paramzze, @Nullable zzg paramzzg)
  {
    IBinder localIBinder = paramzze.asBinder();
    if (paramzzg != null) {}
    for (paramzze = paramzzg.asBinder();; paramzze = null) {
