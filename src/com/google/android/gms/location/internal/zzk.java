...
public class zzk
{
  ...
  private zza zza(LocationCallback paramLocationCallback, Looper paramLooper)
  {
    synchronized (adN)
    {
      zza localzza2 = (zza)adN.get(paramLocationCallback);
      zza localzza1 = localzza2;
      if (localzza2 == null) {
        localzza1 = new zza(paramLocationCallback, paramLooper);
      }
      adN.put(paramLocationCallback, localzza1);
      return localzza1;
    }
  }
  ...
  {
    ady.zzarv();
    ((zzi)ady.zzarw()).zza(LocationRequestUpdateData.zzb(paramPendingIntent, paramzzg));
  }
  ...
  {
    ady.zzarv();
    zzab.zzb(paramLocationCallback, "Invalid null callback");
    synchronized (adN)
    {
      paramLocationCallback = (zza)adN.remove(paramLocationCallback);
      if (paramLocationCallback != null)
      {
        paramLocationCallback.release();
        ((zzi)ady.zzarw()).zza(LocationRequestUpdateData.zza(paramLocationCallback, paramzzg));
      }
      return;
    }
  }
  ...
  {
    ady.zzarv();
    ((zzi)ady.zzarw()).zza(LocationRequestUpdateData.zza(LocationRequestInternal.zzb(paramLocationRequest), paramPendingIntent, paramzzg));
  }
    ...
    throws RemoteException
  {
    ...
    ((zzi)ady.zzarw()).zza(LocationRequestUpdateData.zza(paramLocationRequestInternal, paramLocationCallback, paramzzg));
  }
  ...
  public LocationAvailability zzbnl()
  {
    ...
    try
    {
      LocationAvailability localLocationAvailability = ((zzi)ady.zzarw()).zzko(mContext.getPackageName());
  ...
  {
    ady.zzarv();
    ((zzi)ady.zzarw()).zzc(paramLocation);
  }
